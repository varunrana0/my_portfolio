function Hero() {
	return (
		<div className="container mx-auto md:px-10 lg:py-36 xl:py-28 py-24 w-full h-full">
			<h2 className="text-base text-skin-light tracking-wide">
				<span className="capitalize tracking-wide">hi,</span> 👋 my name is
			</h2>

			<h1 className="w-fit text-[40px] text-skin-extraLight md:text-7xl md:mb-5 mb-3">
				<span className="block capitalize font-black mb-1 tracking-wide">
					varun rana.
				</span>
			</h1>

			<p className="mb-10 text-4xl md:text-8xl font-black text-skin-base">
			...
			<a
				href={"/#projects"}
				className="p-2 capitalize font-black text-sm md:text-lg tracking-wider before:block before:absolute before:-inset-1 before:-skew-y-3 before:bg-skin-base relative inline-block before:rounded-md">
